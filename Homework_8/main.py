...
source_of_input = user_input.read_correct_char(("0", "1", "2"),
                                               "choose source of import: 0 for txt file, 1 for console, 2 for json file: ")
...
elif source_of_input == "2":                                                                # new part of 'main' code for handling input from file
    source_file = ReadContentFromJson(handling_types=("News", "Advert", "UserComment"))     # create object to read file input
    list_of_draft_publications = source_file.read_content()                                 # read file content, clean data, normalize 'text' field, return list to a variable
    for draft_publication in list_of_draft_publications:                                    # loop through a list of data suitable for publication creating
